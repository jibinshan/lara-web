    ...
    return (
        <nav className={cn(`${position} top-0 z-50 flex h-[10vh] w-full flex-col items-center bg-transparent p-4 transition-all duration-0 ease-in-out`, isScrolled && "bg-black")}>
            <div className="flex w-full max-w-[1300px] flex-col items-center gap-2">
                <div className={cn("mb-2 flex w-full justify-between border-white/30 md:border-b md:py-2", (isScrolled || pathname !== "/") && "hidden")}>
                    <div className="hidden flex-row items-center gap-2 md:flex md:gap-4">
                        <Link href="https://maps.app.goo.gl/Ra3eBuEFHEJpSa7E9" target="_blank" className="flex items-center gap-2 text-sm text-white md:text-sm">
                    ...
                    <div className="hidden flex-row items-center gap-2 md:flex md:gap-4">
                        <Link href="tel:0116 235 2888" target="_blank" className="flex items-center gap-2 text-sm text-white md:text-sm">
                            <Phone />
                            0116 235 2888
                        </Link>
                        <Link href="mailto:lararestaurant2024@outlook.com" target="_blank" className="flex items-center gap-2 text-sm text-white md:text-sm">
                            <Mail />
                ...
                <div className="flex h-full w-full items-center justify-between">
                    ...
                    <div className="hidden flex-row items-center justify-center gap-[3.48rem] md:flex">
                        ...
                        <Button asChild variant="link" className={cn("flex", isScrolled || pathname !== "/" ? "px-0 uppercase text-accent" : "hidden")}>
              ...
              <CartSheet>
                ...
                >
                  ...
                  <Icons.shoppingCart className="z-0" />
                        ...
                        <div className={cn("flex", (isScrolled || pathname !== "/") && "hidden")}>
                        ...
                        <div className={cn("hidden", (isScrolled || pathname !== "/") && "flex")}>
                            <Link href="tel:0116 235 2888" target="_blank" className="flex items-center gap-2 text-lg text-white md:text-sm">
                                <Phone />
                                0116 235 2888
                            </Link>
                        </div>
