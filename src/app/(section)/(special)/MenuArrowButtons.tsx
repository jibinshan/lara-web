...
export const PrevButton: React.FC<PropType> = (props) => {
    ...
    return (
        <Button
            variant="outline"
            size="icon"
            className={cn("group/btn h-10 w-10 rounded-full border-0 border-primary text-foreground hover:bg-primary", "-left-12 top-1/2 -translate-y-1/2")}
            {...restProps}
        >
            <div
...
export const NextButton: React.FC<PropType> = (props) => {
    ...
    return (
        <Button
            variant="outline"
            size="icon"
            className={cn("group/btn h-10 w-10 rounded-full border-0 border-primary text-foreground hover:bg-primary", "-right-12 top-1/2 -translate-y-1/2")}
            {...restProps}
        >
            <div
                className="absolute inset-0 flex rounded-full group-hover/btn:hidden"
