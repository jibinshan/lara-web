...
const Reviews = ({ }) => {
    return (
        <section className="relative flex h-full w-full justify-center bg-[#0b0b0b]">
            <div className="flex h-full w-full max-w-[1300px] flex-col items-start justify-center gap-7 py-12 md:py-44 md:pt-12">
                <div className="flex h-full w-full flex-col items-start justify-center gap-2 lg:gap-4">
                    <h1 className="w-full text-center text-[#C1C1C1] font-gotu font-light text-5xl">
                        Hear Our<br /> Guests
                    </h1>
                </div>
                    ...
                    <Carousel className="w-full px-4">
                        <CarouselContent className="ml-4 flex w-full justify-center gap-4">
                            {reviews.map((review, index) => (
                                <CarouselItem
                                    key={index}
                                    className="flex w-full basis-full flex-col justify-between gap-6 rounded-2xl border border-[#0f0f0f] bg-[#0f0f0f] px-6 py-8 md:basis-1/3"
                                >
