        ...
        <footer className="flex h-full w-full flex-col items-center justify-center gap-12 bg-[#131313] px-2 py-12">
            <div className="flex w-full max-w-[1300px] flex-col items-center gap-4 md:flex-row">
                <div className="hidden w-full flex-col items-center justify-center gap-4 md:flex md:w-1/3">
                    <Button className="w-fit items-center justify-center bg-transparent px-0 py-0 text-start text-xl text-[#959595] text-accent hover:bg-transparent" asChild>
                        <div className="group relative w-fit">
                            <Link href="/menu">Menu</Link>
                            <span className="absolute bottom-0 left-1/2 h-0.5 w-0 bg-accent transition-all duration-300 group-hover:w-full group-hover:translate-x-[-50%]"></span>
                            <span className="absolute bottom-[-0.25rem] left-1/2 h-0.5 w-0 bg-accent transition-all duration-300 group-hover:w-full group-hover:translate-x-[-50%]"></span>
                        </div>
                    </Button>
                    <Button className="w-fit items-center justify-start bg-transparent px-0 py-0 text-start text-xl text-[#959595] text-accent hover:bg-transparent" asChild>
                        <div className="group relative w-fit">
                ...
                <div className="flex w-full flex-col items-center justify-center gap-4 md:hidden md:w-1/3">
                    <Button variant="link" className="w-fit items-center justify-start px-0 py-0 text-start text-xl text-[#959595] text-accent" asChild>
                        <Link href="/menu">Menu</Link>
                    </Button>
                    <Button variant="link" className="w-fit items-center justify-start px-0 py-0 text-start text-xl text-[#959595] text-accent" asChild>
                        <Link href="/about-us">About</Link>
                ...
                <div className="flex w-full flex-col items-center justify-center gap-4 md:w-1/3">
                    <div></div>
                    <p className="font-semibold uppercase text-[#959595]">Opening hours</p>
