...
export const Icons = {
    ...
    rightArrow: (props: IconProps) => (
        <svg width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            <g id="Group 2">
                <g id="Group 4">
                    <path id="Vector" d="M0 7.5H16.4072" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" />
                    <path id="Vector_2" d="M10 1.24658L16.4072 7.49982L10 13.7531" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" />
                </g>
            </g>
        </svg>
    ),
    menu: (props: IconProps) => (
        <svg width="46" height="24" viewBox="0 0 46 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    dining: (props: IconProps) => (
        <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            <g id="Frame">
                <path id="Vector" d="M1.64288 28.5713H31.3572" stroke="currentColor" strokeWidth="2" strokeLinecap="square" strokeLinejoin="round" />
                <path id="Vector_2" d="M31 21H2C2 12.7152 8.49256 6 16.5008 6C24.509 6 31 12.7152 31 21Z" stroke="currentColor" strokeWidth="2" strokeMiterlimit="10" />
                <path id="Vector_3" d="M17 2V6" stroke="currentColor" strokeWidth="2" strokeMiterlimit="10" />
            </g>
        </svg>
    ),
        ...
        <svg width="33" height="27" viewBox="0 0 33 27" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            <defs>
                <clipPath id="clip0_109_828">
                    <rect width="32.1845" height="25.7476" fill="white" transform="translate(0.367706 0.509766)" />
                </clipPath>
            </defs>
        </svg>
    ),
    ...
    add: (props: IconProps) => (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" {...props}>
            ...
            <path d="M7 12L17 12M12 17L12 7" stroke="currentColor" strokeWidth="2" strokeLinecap="square" strokeLinejoin="round" />
        </svg>
    ),
    remove: (props: IconProps) => (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" {...props}>
            <rect width="24" height="24" rx="12" fill="#BC995D" />
            <path d="M7 12L17 12" stroke="currentColor" strokeWidth="2" strokeLinecap="square" strokeLinejoin="round" />
        </svg>
    ),
