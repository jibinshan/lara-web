    ...
    return (
        <section id="welcome" className="flex w-full items-center justify-center bg-[#131313] lg:h-screen">
            <div className="relative flex h-fit w-full flex-col items-center justify-center gap-9 overflow-hidden px-3 py-12 lg:min-h-[100vh] lg:flex-row lg:gap-0 lg:p-0 lg:py-24">
                <div className="center-img lg:top-5/12 flex h-fit w-fit items-center justify-center overflow-hidden lg:absolute lg:left-[450px]">
                    <Image src="/images/welcome/center.png" width={450} height={722} alt="center" className="h-[550px] w-[350px]" />
                </div>
                <div className="z-40 flex h-full w-full max-w-[1300px] flex-col items-center justify-center gap-5 lg:flex-row lg:items-start lg:gap-9">
                    <div className="section-one mt-[200px] flex w-full flex-col items-start justify-start gap-10 lg:w-1/2">
                        <p className="w-full text-center font-gotu text-2xl text-[#727272] lg:-ml-[130px] lg:text-lg">Welcome</p>
                        <div className="flex w-full justify-center lg:justify-center">
                            <p className="font-gotu text-5xl lg:text-7xl">
                                ...
                                <br />
                                <span className="w-full pl-28 text-end text-[#C1C1C1]">Flavor</span>
                            </p>
                        </div>
                    </div>
                    <div className="flex w-full flex-col items-center justify-center lg:w-1/2 lg:items-end">
                        <div className="section-two flex flex-col gap-5">
                            <Image src="/images/welcome/logo.png" width={118} height={118} alt="center" className="" />
                            <p className="text-[#FEC679]">About Us</p>
                            <p className="w-[320px] text-[#BBB4AA]">
                                Here at Lara Restaurant we have over 20 year`s experience. With all our dishes are prepared daily with authentic fresh ingredients. Discover the
                                taste of our delicious meat, chicken & fish at our new restaurant.
                            </p>
