...
export const metadata: Metadata = {
    title: "Lara Restaurant Leicester | Authentic Turkish Restaurant | Grill Platters Famous",
    description:
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
    return (
        <html lang="en" suppressHydrationWarning>
            ...
            <body className={cn("theme-custom flex min-h-screen bg-[#070707] font-poppins text-[#FBEAD2] antialiased", manrope.variable, poppins.variable, playfair.variable)}>
